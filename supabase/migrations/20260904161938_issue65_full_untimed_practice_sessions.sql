...
grant execute on function exam_delivery.practice_availability(uuid,jsonb),exam_delivery.list_current_attempt_bindings(uuid,text,text),
  exam_delivery.resume_attempt(uuid,uuid),exam_delivery.discover_current_attempt(uuid,text,text,text,text,text),
  exam_delivery.list_attempt_item_page(uuid,uuid,integer,integer),
