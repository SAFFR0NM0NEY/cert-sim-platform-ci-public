...
export default function ProtectedExamRunner({
  ...
  return <ExamWorkspacePresentation
      ...
      progressLabel={getProtectedProgressLabel(current, currentIndex, items, itemPage.totalCount)}
...
function getProtectedProgressLabel(question, index, items, totalCount = items.length) {
  ...
  return `Standard Questions: Question ${question.questionNumber ?? index + 1} of ${Math.max(sectionItems.length, totalCount)}`;
}
